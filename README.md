...
To install this custom version on your comma 3:

1. On your comma three, go to `Settings` ▶️ `Software`
2. Select `Custom Software` or use the installation URL
3. Use the custom installation URL: `https://install.sunnypilot.ai/custom-staging-c3`
