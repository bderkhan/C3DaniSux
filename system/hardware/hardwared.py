...
ALLOWED_TICI_BRANCHES = {"release-new", "release-tici", "master-mici", "beta", "beta-pq", "dani-sux"}
  ...
  while not end_event.is_set():
    ...
    if msg.deviceState.memoryUsagePercent > 85:
      ...
      perf.emit(
        ...
        top_processes=[str(p) for p in top_processes],
    ...
    if params.get_bool("FastSleep") and not tesla_no_sleep:
      if low_power:
