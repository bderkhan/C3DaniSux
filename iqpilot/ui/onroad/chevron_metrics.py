...
class ChevronMetrics:
  ...
  def _render_text_lines(self, text_lines: list[str], chevron_x: float, chevron_y: float,
    ...
    if text_y + total_height > rect_bottom - margin:
      y_max = min(chevron_y, rect_bottom - margin)
    ...
    for i, line in enumerate(text_lines):
      ...
      if y + line_height > rect_bottom - margin:
        break
      ...
      x = int(np.clip(x, rect.x + margin, rect_right - text_width - margin))
