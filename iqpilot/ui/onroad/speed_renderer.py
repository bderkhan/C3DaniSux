...
VW_MQB_NON_CLUSTER_FLAGS = VolkswagenFlags.PQ | VolkswagenFlags.MLB | VolkswagenFlags.MEB | VolkswagenFlags.MEB_GEN2 | VolkswagenFlags.MQB_EVO
...
class SpeedRenderer:
  ...
  def update(self) -> None:
    ...
    CP = ui_state.CP
    is_vw_mqb = CP is not None and CP.brand == "volkswagen" and not (CP.flags & VW_MQB_NON_CLUSTER_FLAGS)
    if is_vw_mqb:
