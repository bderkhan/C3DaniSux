...
def _iter_proprietary_python_roots() -> list[Path]:
  ...
  _artifact_names = ["iqpilot_model_selector_private", "iqpilot_navd_private", "iqpilot_hephaestusd_private", "iqpilot_alc_private", "iqpilot_commander_private", "iqpilot_updater_private"]
