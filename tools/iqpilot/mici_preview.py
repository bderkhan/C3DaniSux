...
def _patch_mock_state():
  ...
  # openpilot.iqpilot.ui.ui_state  (IQ-specific layer)
  mock_iq_ui_mod = types.ModuleType("openpilot.iqpilot.ui.ui_state")
  mock_iq_ui_mod.ui_state = _mock_ui_state
  sys.modules["openpilot.iqpilot.ui.ui_state"] = mock_iq_ui_mod
